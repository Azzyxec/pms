...
$(document).ready(function(){
     ...
     $('#datetimepicker6').datetimepicker({
       ...
       /*$('#datetimepicker4').data('DateTimePicker').widgetPositioning({
          horizontal:"right",
           vertical : "bottom"
       });*/
